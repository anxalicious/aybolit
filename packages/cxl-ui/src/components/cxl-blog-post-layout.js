...
import cxlBlogLayoutStyles from '../styles/cxl-blog-layout-css.js';
import cxlBlogLayoutGlobalStyles from '../styles/global/cxl-blog-layout-css.js';
...
@customElement('cxl-blog-post-layout')
export class CXLBlogPostLayout extends LitElement {
  @query('aside')
  asideElement;
  ...
  firstUpdated(_changedProperties) {
    ...
    // Global styles.
    registerGlobalStyles(cxlBlogLayoutGlobalStyles, {
      moduleId: 'cxl-blog-layout-global'
    });
  }
}
